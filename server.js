...
app.use('/user_application', require('./routes/user/application'))
app.use('/user_training', require('./routes/user/training'))
app.use('/user_registration', require('./routes/user/registration'))
...
// kip route for both user (individual) and organization
app.use('/kip_scholarship', require('./routes/kip/scholarship'))
app.use('/kip_training', require('./routes/kip/training'))
...
app.use('/organization_application', require('./routes/organization/application'))
app.use('/organization_training', require('./routes/organization/training'))
app.use('/organization_registration', require('./routes/organization/registration'))
...
app.use('/admin_application', require('./routes/admin/application'))
app.use('/admin_scholarship', require('./routes/admin/scholarship'))
app.use('/admin_training', require('./routes/admin/training'))
